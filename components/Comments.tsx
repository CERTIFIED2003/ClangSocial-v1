      ...
      {userProfile && (
        <form className="flex gap-4 mt-5 mb-2 lg:hidden" onSubmit={addComment}>
          <input
            ...
            className="bg-primary px-6 py-4 text-md font-medium border-2 w-[250px] md:w-[700px] lg:w-[350px] border-gray-200 focus:outline-none focus:border-2 focus:border-opacity-50 focus:border-[#F51997] rounded-full flex-1" />
          <button
          ...
          <div className="absolute bottom-0 left-0 pb-6 hidden lg:block px-2 md:px-10">
            <form className="flex gap-4" onSubmit={addComment}>
              <input
                ...
                onChange={(e) => setComment(e.target.value)}
                placeholder="Add Comment"
                className="bg-primary px-6 py-4 text-md font-medium border-2 w-[250px] md:w-[700px] lg:w-[350px] border-gray-200 focus:outline-none focus:border-2 focus:border-gray-300 rounded-full flex-1" />
              <button
                className="text-md text-gray-400"
                onClick={addComment}
              >
