  ...
  return (
    <div className='flex flex-col w-auto'>
      <div className="w-full flex justify-between items-center border-b-2 border-transparent py-2 px-4">
        <Link href="/">
          <div className="w-[140px] mr-2 md:w-[250px]">
            <Image
              unoptimized={true}
              className="cursor-pointer"
              src={require('../utils/logo.gif')}
              // src={Logo}
              alt="Clang Social"
            />
          </div>
          ...
          <div className="relative md:hidden xl:hidden">
            ...
            >
              <input
                ...
                className="bg-primary p-3 md:text-md font-medium border-2 border-gray-200 focus:outline-none focus-border-2 focus:border-gray-300 w-[200px] md:w-[350px] rounded-full md:top-0"
              />
              <button
