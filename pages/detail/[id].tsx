  ...
  return (
    <div className="flex w-full justify-center absolute left-0 top-0 bg-white flex-wrap lg:flex-nowrap">
      {/* {post.previewtype === 'video' ? (
        ...
        <div className="relative flex-2 w-[1000px] lg:w-9/12 flex justify-center items-center xl:bg-black md:bg-black">
      ...
      <div className="relative w-[1000px]  md:w-[900px] lg:w-[700px]">
        <div className="lg:mt-20 mt-0 md:mt-5">
          <div className="flex gap-3 p-2 font-semibold pt-14 rounded">
