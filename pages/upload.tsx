    ...
    return (
        <div className="flex w-full h-full absolute left-0 top-[70px] md:top-[87px] mb-10 pt-5 md:pt-14 lg:pt-10 bg-[#F8F8F8] justify-center">
            <div className="bg-white w-[80%] rounded-lg xl:h-[80vh] md:h-[110vh] h-[110vh] flex gap-6 flex-wrap justify-evenly items-center p-14 pt-6">
                <div>
                    <div>
                        <span className="text-2xl font-bold text-[#F51997]">Upload</span><span className="text-2xl font-bold"> an Image</span>
                                        ...
                                        (
                                            <label className="cursor-pointer">
                                                <div className="flex flex-col items-center justify-center w-full h-full">
                                                    ...
                                                    <div className="container align-center cursor-pointer">
                                                        <input
                                                            type='file'
                                                            name='upload-video'
                    ...
                    <div className="flex gap-6 mt-10">
                        ...
                        {savingPost ?
                            (<button
                                onClick={() => {}}
                                type="button"
                                className="border-gray-400 border-2 text-gray-400 text-md font-medium p-2 rounded w-28 lg:w-44 outline-none"
                            >
                                Posting
                            </button>) :
                            (<button
